...
const Socials = () => {
  return (
    <div>
        <div className="min-h-[450px] py-14 flex gap-20 flex-col lg:flex-row sm:flex-wrap justify-center items-center bg-[#d9c7e6]">
        <h1 className="mb-8 text-2xl font-medium text-black sm:text-4xl md:mb-12 md:text-4xl">Follow me on socials. <br/><div className='text-[#ff7e20] '>
         (Hover on the image) </div></h1>
<div className="relative z-[50]">
  <div className="semi-circle -rotate-[47deg] w-[295px] h-[271px] rounded-[100px_100px_0_0] sm:rounded-[400px_400px_0_0] sm:w-[411px] sm:h-[251px] -top-[123px] -left-[139px] sm:-left-[118px] sm:-top-[41px] absolute bg-[#f1f5fd] z-50"></div>
  <div className="relative h-[200px] w-[200px] sm:h-[300px] sm:w-[300px] group rounded-full bg-[#8b00e7] cursor-pointer">
    <img
